package com.example.basicman.Service;
...
import com.example.basicman.activity.MainActivity;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    ...
    private RemoteViews customView(String title, String body) {
        ...
        remoteViews.setImageViewResource(R.id.imgnoti, R.drawable.baseline_smartphone_24);
        return remoteViews;
    }
